            ...
            <form action="#" method="post">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingInput"placeholder="Ingrese su usuario"
                           required autofocus pattern="[A-Za-z0-9]{2,30}">
                    <label for="floatingInput">Usuario</label>
                </div>
                <br>
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingfirsname"placeholder="Ingrese su nombre"
                           required pattern="[A-Za-z0-9]{2,40}">
                    <label for="floatingfirsname">Nombre</label>
                </div>
                <br>
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingLastname"placeholder="Ingrese su apellido"
                           required pattern="[A-Za-z0-9]{2,40}">
                    <label for="floatingLastname">Apellido</label>
                </div>
                <br>
                <div class="form-floating">
                    <input type="email" class="form-control" id="floatingEmail"placeholder="Ingrese su Gmail"
                           required autofocus pattern="[A-Za-z0-9]{5,60}">
